...
boot_anim = [f"{Style.BRIGHT}{Fore.LIGHTWHITE_EX}Booting {Fore.RED}Jesus {Fore.RESET}{Fore.LIGHTWHITE_EX}Bot",
             f"{Fore.RED}25%",
             f"{Fore.YELLOW}50%",
...
async def massdm():
        ...
        input(f"\n{Fore.WHITE}Thanks for using {Fore.YELLOW}Jesus\nPress Enter to return to the main menu")
        return await main()
...
async def exit():
        await client.close()
        input(f"{Fore.WHITE}Thanks for using {Fore.YELLOW}Jesus\nPress Enter 5 times to close the program.")
...
'''))
    print(f'''
{Fore.LIGHTWHITE_EX}Made by {Fore.YELLOW}Jesus#2002    
...
{Connected}
[1] Raid The Server     | [2] Mass Dm Client Users  | [3] Mass Embed Dm Client Users
[4] Leave all Servers   | [5] Mass Dm               | [6] Mass Embed Dm
[7] Display all Servers | [8] Mass Dm Friends       | [9] Mass Embed Dm Friends
[10] Give Members Admin | [0] Nuke The Server  
